...
x11(12, 10)
png("Mass gained2.png", width= 800, height = 600, pointsize= 12)
...
text(2, max(Wgpam[,1])*1.03, "*")
text(3, max(Wgpm[,1])*1.03, "*")
text(6, max(Wgpam[,2])*1.03, "*")
text(7, max(Wgpm[,2])*1.03, "*")
text(10, max(Wgpam[,3])*1.03, "*")
text(11, max(Wgpm[,3])*1.03, "*")
text(14, max(Wgpam[,4])*1.03, "*")
text(15, max(Wgpm[,4])*1.03, "*")
...
x11(12, 10)
png("Daily growth2.png", width= 800, height = 600, pointsize= 12)
layout(matrix(c(1, 2),ncol=1, nrow=2), width=c(0.8, 0.2), heights = c(0.1, 0.8))
layout.show(2)
...
mtext("Males GC1", side=1, line=1, at=14, las=1)
mtext("Males GC2", side=1, line=1, at=18, las=1)
text(2, max(Wg_dpam[,1])*1.03, "*")
text(3, max(Wg_dpm[,1])*1.03, "*")
text(6, max(Wg_dpam[,2])*1.03, "*")
text(10, max(Wg_dpam[,3])*1.03, "*")
text(14, max(Wg_dpam[,4])*1.03, "*")
text(15, max(Wg_dpm[,4])*1.03, "*")
...
x11(12, 10)
png("Ingestion rate2.png", width= 800, height = 600, pointsize= 12)
layout(matrix(c(1, 2),ncol=1, nrow=2), width=c(0.8, 0.2), heights = c(0.1, 0.8))
layout.show(2)
...
mtext("Males GC1", side=1, line=1, at=14, las=1)
mtext("Males GC2", side=1, line=1, at=18, las=1)
text(2, max(JT_Xpam[,1])*1.03, "*")
text(3, max(JT_Xpm[,1])*1.03, "*")
text(6, max(JT_Xpam[,2])*1.03, "*")
text(7, max(JT_Xpm[,2])*1.03, "*")
text(10, max(JT_Xpam[,3])*1.03, "*")
text(11, max(JT_Xpm[,3])*1.03, "*")
text(14, max(JT_Xpam[,4])*1.03, "*")
text(15, max(JT_Xpm[,4])*1.03, "*")
text(18, max(JT_Xpam[,5])*1.03, "*")
text(19, max(JT_Xpm[,5])*1.03, "*")
...
x11(12, 10)
png("Faecal2.png", width= 800, height = 600, pointsize= 12)
layout(matrix(c(1, 2),ncol=1, nrow=2), width=c(0.8, 0.2), heights = c(0.1, 0.8))
layout.show(2)
...
mtext("Males GC1", side=1, line=1, at=14, las=1)
mtext("Males GC2", side=1, line=1, at=18, las=1)
text(2, max(JT_Ppam[,1])*1.03, "*")
text(3, max(JT_Ppm[,1])*1.03, "*")
text(6, max(JT_Ppam[,2])*1.03, "*")
text(10, max(JT_Ppam[,3])*1.03, "*")
text(11, max(JT_Ppm[,3])*1.03, "*")
text(14, max(JT_Ppam[,4])*1.03, "*")
text(15, max(JT_Ppm[,4])*1.03, "*")
text(18, max(JT_Ppam[,5])*1.03, "*")
text(19, max(JT_Ppm[,5])*1.03, "*")
...
x11(12, 10)
png("Respiration2.png", width= 800, height = 600, pointsize= 12)
layout(matrix(c(1, 2),ncol=1, nrow=2), width=c(0.8, 0.2), heights = c(0.1, 0.8))
layout.show(2)
...
mtext("Males GC1", side=1, line=1, at=14, las=1)
mtext("Males GC2", side=1, line=1, at=18, las=1)
text(2, max(EJOpam[,1])*1.03, "*")
text(3, max(EJOpm[,1])*1.03, "*")
text(6, max(EJOpam[,2])*1.03, "*")
text(7, max(EJOpm[,2])*1.03, "*")
text(10, max(EJOpam[,3])*1.03, "*")
text(11, max(EJOpm[,3])*1.03, "*")
text(14, max(EJOpam[,4])*1.03, "*")
text(18, max(EJOpam[,5])*1.03, "*")
text(19, max(EJOpm[,5])*1.03, "*")
...
x11(12, 10)
png("Excretion2.png", width= 800, height = 600, pointsize= 12)
layout(matrix(c(1, 2),ncol=1, nrow=2), width=c(0.8, 0.2), heights = c(0.1, 0.8))
layout.show(2)
...
mtext("Males GC1", side=1, line=1, at=14, las=1)
mtext("Males GC2", side=1, line=1, at=18, las=1)
text(6, max(EJNpam[,2])*1.03, "*")
text(7, max(EJNpm[,2])*1.03, "*")
text(10, max(EJNpam[,3])*1.03, "*")
text(11, max(EJNpm[,3])*1.03, "*")
text(14, max(EJNpam[,4])*1.03, "*")
text(15, max(EJNpm[,4])*1.03, "*")
text(18, max(EJNpam[,5])*1.03, "*")
text(19, max(EJNpm[,5])*1.03, "*")
